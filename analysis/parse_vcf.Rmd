...
```{r}
library(vcfR)
vcf <- read.vcfR(file = "../data/vcf_Guilherme/myGBSGenos_mergedSNPs_mergedTaxa_chr1.vcf",
                 verbose = FALSE)
```
...
for (chr_index in 1:9) {
  inname <- paste0("../data/vcf_Guilherme/myGBSGenos_mergedSNPs_mergedTaxa_chr", chr_index, ".vcf")
  outname <- paste0("../output/allele_counts/chr", chr_index, "_ct.RDS")
